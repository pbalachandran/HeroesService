...
public class TestUtils {
    ...
    public String readFixture(String service, String fixtureName) throws IOException {
    ...
    public static String readJsonFixture(String fixtureName, Map<String, Object> values) throws IOException {
        Scanner scanner =
                new Scanner(TestUtils.class.getResourceAsStream("/fixtures/" + fixtureName)).useDelimiter("\\A");
